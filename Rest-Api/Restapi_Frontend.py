            ...
            def __init__(self, root1):
                ...
                def insert_table():
                    ...
                    def inserting():
                        ...
                        if job_id != "" and job_name != "" and location != "" and description != "" and skills != "":
                            req3 = requests.post(
                                "http://127.0.0.1:8000/insert?job_id=" + job_id + "&job_name=" + job_name + "&location=" + location + "&description=" + description + "&skills=" + skills)
                ...
                def delete():
                    ...
                    def deleting():
                        ...
                        try:
                            ...
                            # req2 = requests.delete("http://127.0.0.1:8000/delete?", params={'job_id_var': 'sdfjdsksfsd'})
